class Apis {
  ...
  static String updatePlayer = "${apiUrl}/player/players";
  // league routes
  ...
  // fixtures
  static String fetchFixtures = "${apiUrl}fixture/fixtures";
  static String createFixture = "${apiUrl}fixture/addfixture";
  static String fetchSingleFixture = "${apiUrl}fixture/fixtures/";
